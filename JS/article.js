    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card h-100 shadow-sm">
        <div class="card-body d-flex flex-column">
          ...
          <button type="button" class="btn liste mt-auto" data-bs-toggle="modal" data-bs-target="#modal-${a.id}">
            Lire plus
          </button>
          ...
          <small class="text-muted mt-2">
            Publié le ${a.date_publication ? a.date_publication.split("-").reverse().join("/") : new Date().toLocaleDateString("fr-FR")}
            par ${a.auteur ?? "Inconnu"}
          </small>
        </div>
      </div>
    </div>
